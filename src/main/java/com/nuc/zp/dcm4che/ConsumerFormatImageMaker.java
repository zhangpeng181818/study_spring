...
public class ConsumerFormatImageMaker {
    private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/ConsumerFormatImageMaker.java,v 1.48 2020/06/22 22:15:37 dclunie Exp $";

    private static final Logger slf4jlogger = LoggerFactory.getLogger(com.pixelmed.display.ConsumerFormatImageMaker.class);
...
//System.err.println("matches");
    ...
    public static void writeEightBitImageForFrame(BufferedImage renderedImage,Iterator<TextAnnotationPositioned> annotations,String outputFileName,String outputFormat,
        ...
        if (annotations != null) {
            ...
            String demographicAndTechniqueFontName = "微软雅黑";
//            int demographicAndTechniqueFontStyle = Font.PLAIN;
            int demographicAndTechniqueFontStyle = Font.PLAIN;
            int demographicAndTechniqueFontSize = 12;
